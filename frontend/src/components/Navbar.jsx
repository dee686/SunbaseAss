...
function Navbar() {
     ...
     const handleSubmit = (e) => {
          dispatch(getAllCustomersAction(toastMsg,0,searchKey,searchValue))
     }
   // search handle  
          ...
          isAuth ? <>
               ...
               <Box
                    ...
                    <Flex gap={4} alignItems='center'>
                         <Button variant='solid' colorScheme='green' minWidth='max-content' onClick={onOpen}>Add Customer</Button>
                         ...
                         <Button variant='solid' colorScheme='green' loadingText="Sync..." onClick={syncCustomer}>Sync</Button>
                         <Button variant='outline' colorScheme='grren' marginLeft='auto'>Log out</Button>
                    </Flex>
               </Box>
